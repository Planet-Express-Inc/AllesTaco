...
from .user_sales import user_sales_bp
from .article_views import article_views_bp

v1_blueprints = [user_bp, article_bp, status_bp, user_cart_bp, user_purchase_bp, user_reviews_bp, user_sales_bp, article_views_bp]